        ...
        >
            ...
            >
                <header className="relative flex items-center justify-center min-h-[32px] pt-8 sm:pt-0">
                    ...
                    <button
                        onClick={onClose}
                        className="absolute top-0 right-0 sm:relative sm:top-auto sm:right-auto bg-[#A30030] text-white rounded-full cursor-pointer hover:bg-red-800 transition-colors"
                        aria-label="Fechar"
                    >
                ...
                <footer className="flex flex-col items-center gap-4 sm:gap-6 mt-2">
                    ...
                    <button className="bg-[#A30030] w-full sm:w-auto hover:bg-red-800 cursor-pointer text-white font-bold py-3 px-6 sm:px-8 rounded-full text-xs sm:text-sm uppercase tracking-wide transition-colors">
