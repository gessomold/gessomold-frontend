...
export default function Header() {
  ...
  return (
    <header
      className="flex w-full p-4 items-center justify-between bg-white sticky top-0 z-50 shadow-sm"
      id="inicio"
    >
      ...
      <a
        ...
        className="hidden md:block bg-primary hover:bg-primary/90 transition-all text-sm font-semibold rounded-lg text-white px-4 py-2"
      >
      ...
      >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-primary text-white px-4 py-2 rounded-lg text-center mt-4"
        >
          Orçamento Sem Compromisso
        </a>
      </div>
